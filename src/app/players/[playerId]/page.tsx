          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "2rem", alignItems: "stretch" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem", height: "100%" }}>
              ...
              {activeTab === "general" && hubStats && (
                <div className="glass-card" style={{ padding: "1.5rem", borderRadius: "16px", border: "1px solid var(--border-light)", display: "flex", flexDirection: "column", gap: "1.25rem", height: "750px", overflowY: "auto", boxSizing: "border-box" }}>
              ...
              {activeTab === "maps" && hubStats && (
                <div className="glass-card" style={{ padding: "1.25rem", borderRadius: "16px", border: "1px solid var(--border-light)", display: "flex", flexDirection: "column", gap: "0.5rem", height: "750px", overflowY: "auto", boxSizing: "border-box" }}>
